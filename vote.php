...
alert('Same Representative is not allowed');
...
//
//vice-governor
$vice2=mysqli_query($conn,"select * from candidate where CandidateID='$vice1'")or die(mysqli_query($conn,));
$row_vice=mysqli_fetch_array($vice2);

$name1=$row_vice['FullName'];
//
//Representative1
...
$name2=$Representative1_row['FullName'];
//
//Representative2
...
$name3=$Representative2_row['FullName'];
//
...
$name4=$Representative3_row['FullName'];
//
